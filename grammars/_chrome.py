...
chrome = AppContext( title = 'chrome')
...
mapping = {
    ...
    "find last [<n>]": Key('ctrl:down,shift:down,g:%(n)d,shift:up,ctrl:up'),
    ...
    "new tab": Key("c-t"),
    "new window": Key("c-n"),
    "tab next [<n>]": Key("c-tab:%(n)d"),
    "tab last [<n>]": Key("c-pgup:%(n)d"),
    ...
    "(dev | developer) tools": Key("ctrl:down,s-j,ctrl:up"),
    "inspect element": Key("ctrl:down,s-c,ctrl:up"),
